...
(function (jQuery) {
    ...
    jQuery.fn.jStepper = function (options) {
        ...
        return this.each(function () {
            ...
            if (o.destroy) {
                $this.unbind("mousewheel.jStepper");
                $this.unbind("keydown.jStepper");
                $this.unbind("keyup.jStepper");
            } else {
                ...
                if (jQuery.isFunction($this.mousewheel)) {
                    $this.bind("mousewheel.jStepper", function (objEvent, intDelta) {
                        if (intDelta > 0) { // Up
                ...
                $this.bind("keydown.jStepper", function (e) {
                    var key = e.keyCode;
                ...
                $this.bind("keyup.jStepper", function (e) {
